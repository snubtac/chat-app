...
io.on('connection', (socket) => {
  ...
  socket.on('join', ({ username, room }, callback) => {
    ...
    // socket.emit sends to a specific connected client
    socket.emit('message', generateMessage('Admin', 'Welcome!'))
    // sends to all in the room except for that specific connected client
  ...
  // Code to run upon any client disconnection
